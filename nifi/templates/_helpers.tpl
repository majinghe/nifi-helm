...
{{- define "embed.zookeeper" }}
{{- printf "%s-0.%s-headless.%s.svc.cluster.local:2181,%s-1.%s-headless.%s.svc.cluster.local:2181,%s-2.%s-headless.%s.svc.cluster.local:2181" .Release.Name .Release.Name .Release.Name .Release.Name .Release.Name .Release.Name .Release.Name .Release.Name .Release.Name }}
{{- end }}
